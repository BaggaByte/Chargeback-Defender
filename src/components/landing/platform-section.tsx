    ...
    <section id="platform" className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-12">
          ...
          <div className="rounded-xl border border-ink-200 bg-white p-7 shadow-[0_1px_2px_rgb(15_23_42/0.04)] lg:col-span-7">
          ...
          {/* Rule intelligence */}
          <div className="flex flex-col rounded-xl border border-ink-200 bg-white p-7 shadow-[0_1px_2px_rgb(15_23_42/0.04)] lg:col-span-5">
          ...
          <div className="rounded-xl border border-ink-200 bg-white p-6 shadow-[0_1px_2px_rgb(15_23_42/0.04)] lg:col-span-4">
